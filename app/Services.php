...
class ImageService
{
    ...
    public function storeOneFileFromRequest(string $collectionName, string $requestFileName)
    {
        if (isset($this->data[$requestFileName])) {
            (new FileOperationService())->storeFileFromRequest(
                class: $this->model,
